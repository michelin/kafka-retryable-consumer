...
public class RetryableConsumerErrorHandler<K, V> {
    ...
    public RetryableConsumerErrorHandler(DeadLetterProducer deadLetterProducer, Collection<String> notRetryableExceptions) {
    ...
    public void handleError(
        ...
        try {
            GenericErrorModel errorAvroObject =
                    GenericErrorModel.newBuilder()
                            .setCause(cause)
        ...
        for (String exceptionName : exceptionNames) {
            try {
                ...
                if (Exception.class.isAssignableFrom(clazz)) {
                    ...
                    throw new IllegalArgumentException("Parameter 'not-retryable-exceptions' must be a list of exception classes");
                }
            } catch (Exception e) {
